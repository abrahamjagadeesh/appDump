...
Storage['portion1'] = localStorage.getItem('portion1') === null ? (localStorage.setItem('portion1', ['MAS', 'AVD']), localStorage.getItem('portion1').split(",")) : localStorage.getItem('portion1').split(",");
